...
Route::middleware(['auth', 'staff'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/applications/registrar-approved', [App\Http\Controllers\AdminController::class, 'registrarApprovedApplications'])->name('applications.registrar-approved');
...
Route::middleware(['auth', 'role:registrar'])->prefix('registrar')->name('registrar.')->group(function () {
    ...
    Route::post('/applications/{application}/change-program', [App\Http\Controllers\RegistrarController::class, 'changeProgram'])->name('applications.change-program');
