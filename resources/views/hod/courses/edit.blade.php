        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Edit Course — {{ $department->name }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('hod.courses.update', $course) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('academic_year') is-invalid @enderror"
                                       id="academic_year" name="academic_year" value="{{ old('academic_year', $course->academic_year) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('semester') is-invalid @enderror" id="semester" name="semester">
                                    ...
                                    <option value="First Semester" {{ old('semester', $course->semester) == 'First Semester' ? 'selected' : '' }}>First Semester</option>
                                    <option value="Second Semester" {{ old('semester', $course->semester) == 'Second Semester' ? 'selected' : '' }}>Second Semester</option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="sort_order" name="sort_order" value="{{ old('sort_order', $course->sort_order) }}" min="0">
                            </div>
                        </div>
