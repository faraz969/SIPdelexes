...
@section('title', 'Edit Form Type - DELEXES UNIVERSITY COLLEGE')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>Edit Form Type
                    </h3>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('admin.form-types.update', $formType) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $formType->name) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" 
                                       ...
                                       id="local_price" name="local_price" value="{{ old('local_price', $formType->local_price) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" 
                                       ...
                                       id="international_price" name="international_price" value="{{ old('international_price', $formType->international_price) }}" 
                                       placeholder="0.00" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.0001" min="0" max="9999.9999"
                                       ...
                                       id="conversion_rate" name="conversion_rate" value="{{ old('conversion_rate', $formType->conversion_rate) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description of this form type">{{ old('description', $formType->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-delexes-primary">
                                <i class="fas fa-save me-1"></i>Update Form Type
                            </button>
